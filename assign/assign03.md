...
* Milestone 1: Friday, October 10th (no late hours)
* Milestone 2: Friday, October 24th by 11pm (max 48 late hours)
* Milestone 3: Friday, October 31st by 11pm
...
Here is starter code that you are welcome to use:
[csf\_assign03.zip](csf_assign03.zip).

Even though you aren't required to have any specific program functionality
working for Milestone 1, we recommend that you do at least make a start.
A couple of good places to start are handling command line arguments
and reading the memory trace file (so that you can read each operation,
determine the address accessed, and know whether the access is a load
or a store.) Getting some of the core data structures
...
within &plusmn;5%, while the other results must be exact.
