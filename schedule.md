...
------------------ | ------------ | ------- | ----------
Aug 25 | [Course overview](lectures/lecture01-public.pdf) | *CSAPP* 1.1–1.9 | 
Aug 27 | [Data representation, addresses](lectures/lecture02-public.pdf) | *CSAPP* 2.1 | 
Aug 29 | [Integer representation](lectures/lecture03-public.pdf) | *CSAPP* 2.2 | 
Sep 1 | *University holiday, no class* |  | 
Sep 3 | [Integer arithmetic](lectures/lecture04-public.pdf) | *CSAPP* 2.3 | [A1](assign/assign01.html) MS1 due
Sep 5 | [Floating point](lectures/lecture05-public.pdf) | *CSAPP* 2.4 | 
Sep 8 | [Machine-level program representation](lectures/lecture06-public.pdf), [addLongs.zip (example code)](lectures/addLongs.zip) | *CSAPP* 3.1–3.4 | 
Sep 10 | [ALU operations, arithmetic](lectures/lecture07-public.pdf), [alu.zip (example code)](lectures/alu.zip) | *CSAPP* 3.5 | [A1](assign/assign01.html) MS2 due
...
Oct 1 | [Memory hierarchy](lectures/lecture15-public.pdf) | *CSAPP* 6.1–6.3 | 
Oct 3 | Exam 1 review session |  | <!--[A2](assign/assign02.html) MS3 due-->
Oct 6 | **Exam 1** (in class) |  | 
Oct 8 | [Cache policies](lectures/lecture16-public.pdf) | *CSAPP* 6.4 | 
Oct 10 | Caches and program execution: see Canvas for slides | *CSAPP* 6.5 | <!--[A3](assign/assign03.html) MS1 due-->
Oct 13 | [Linking basics, symbols, relocations, executables, loading](lectures/lecture18-public.pdf) | *CSAPP* 7.1–7.9 | 
Oct 15 | [Dynamic linking, shared libraries, PIC, interpositioning](lectures/lecture19-public.pdf), [dynload.zip (example code)](lectures/dynload.zip) | *CSAPP* 7.10–7.15 | 
Oct 16–17 | *WSE Fall Break, no class* |  | 
Oct 20 | [Exceptions, Processes](lectures/lecture20-public.pdf) | *CSAPP* 8.1–8.4, 8.7 | 
Oct 22 | [Signals](lectures/lecture21-public.pdf), [signals.zip (example code)](lectures/signals.zip) | *CSAPP* 8.5–8.6 | 
Oct 24 | [Virtual memory](lectures/lecture22-public.pdf) | *CSAPP* 9.1–9.3 | <!--[A3](assign/assign03.html) MS2 due-->
Oct 27 | [Memory management, address translation](lectures/lecture23-public.pdf) | *CSAPP* 9.4–9.7 | 
Oct 29 | [Memory mapping, dynamic memory allocation](lectures/lecture24-public.pdf) | *CSAPP* 9.8, 9.9, 9.11 | 
Oct 31 | Exam 2 review session |  | <!--[A3](assign/assign03.html) MS3 due-->
Nov 3 | **Exam 2** (in class) |  | 
Nov 5 | [Unix I/O, files](lectures/lecture25-public.pdf) | *CSAPP* 10.1–10.11 | 
Nov 7 | [Networks, Internet Protocol](lectures/lecture26-public.pdf) | *CSAPP* 11.1–11.3 | <!--[A4](assign/assign04.html) due-->
Nov 10 | [Sockets, Application Protocols](lectures/lecture27-public.pdf), [sockets.zip (example code)](lectures/sockets.zip) | *CSAPP* 11.4 | 
